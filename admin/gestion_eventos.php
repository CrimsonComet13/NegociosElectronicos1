...
// Obtener todos los eventos con información de colaboradores
try {
    $stmt = $conn->query(
        "SELECT e.*, 
  ...
  <style>
    ...
    * {
    ...
    @media (max-width: 768px) {
      ...
      .table th:nth-child(4),
      .table td:nth-child(4) {
        display: none; /* Ocultar columna de clientes en móvil */
      }

      .table th:nth-child(5),
      .table td:nth-child(5) {
        display: none; /* Ocultar colaboradores en móvil */
      }
    }
    ...
    @media (max-width: 576px) {
      .table th:nth-child(3),
      .table td:nth-child(3) {
        display: none; /* Ocultar fecha en pantallas muy pequeñas */
      }
    }
                    ...
                    <td>
                      <div class="d-flex flex-wrap gap-2">
                        ...
                        <?php if ($estado !== 'pendiente'): ?>
                          <a
                            href="?action=update_status&id=<?php echo $evento['id']; ?>&status=pendiente"
                        ...
                        <?php if ($estado !== 'confirmado'): ?>
                          <a
                            href="?action=update_status&id=<?php echo $evento['id']; ?>&status=confirmado"
                        ...
                        <?php if ($estado !== 'completado'): ?>
                          <a
                            href="?action=update_status&id=<?php echo $evento['id']; ?>&status=completado"
                        ...
                        <?php if ($estado !== 'cancelado'): ?>
                          <a
                            href="?action=update_status&id=<?php echo $evento['id']; ?>&status=cancelado"
                        ...
                        <!-- Eliminar evento -->
                        <a
                          href="?action=delete&id=<?php echo $evento['id']; ?>"
                          class="btn btn-sm btn-secondary"
    ...
    document.addEventListener('DOMContentLoaded', function() {
      document.querySelectorAll('.btn').forEach(element => {
        element.addEventListener('click', function(e) {
          // No crear ripple si es un enlace real (navegación)
